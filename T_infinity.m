...
All_T_max=[61.5 65.2 72.2 79.8 86.5 92.1 95.6 97 90.5 81.8 71.4 62.7];    %T max for every month in F
All_T_min=[41.5 44.8 51.3 58.6 66.7 72.3 74.4 74.6 69.4 60.6 50.6 42.3];  %T min for every month in F
